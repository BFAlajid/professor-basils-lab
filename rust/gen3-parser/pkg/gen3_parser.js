/* @ts-self-types="./gen3_parser.d.ts" */
 ...
 * @returns {string}
 */
export function decodeGen3String(data, offset, max_len) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decodeGen3String(ptr0, len0, offset, max_len);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
export function parseGen3Save(buffer) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parseGen3Save(ptr0, len0);
    return ret;
}
